        ...
        return(
            <div className="project-container">
                ...
                <div className="project">
                    ...
                    <div className="project-item">
                    <a href="https://github.com/reynaldoayala062/finish-line-frontend" target="blank">Git Hub</a>
                    </div>
                </div>
                <br/>
                <div className="project">
                    ...
                    <div className="project-item">
                    <a href="https://github.com/smithspencer817/mountainman" target="blank" ><h1>Git Hub</h1></a>
                    </div>
                </div>
                <br/>
                <div className="project">
                    ...
                    <div className="project-item">
                    <a href="https://github.com/reynaldoayala062/Connecting-the-Dots-Frontend" target="blank" >Git Hub Frontend</a>
                    <a href="https://github.com/reynaldoayala062/Connecting-the-Dots-Backend" target="blank" >Git Hub Backend</a>
                    </div>
                </div>
                <br/>
                <div className="project">
                    ...
                    <div className="project-item">
                    <a href="https://github.com/reynaldoayala062/block-buster" target="blank" >Git Hub</a>
                    </div>
                </div>
